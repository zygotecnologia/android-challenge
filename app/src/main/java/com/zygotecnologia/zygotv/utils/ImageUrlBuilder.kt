...
object ImageUrlBuilder {
    ...
    fun buildPosterUrl(posterPath: String) =
        POSTER_URL + posterPath + getImageUrlQueryString()

    fun buildBackdropUrl(backdropPath: String) =
        BACKDROP_URL + backdropPath + getImageUrlQueryString()

    private fun getImageUrlQueryString() =
                "?${TmdbClient.TMDB_API_QUERY}=" + Keys.apiKey() +
